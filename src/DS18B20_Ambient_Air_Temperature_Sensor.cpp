...
/**************************************************************************************************/
void DS18B20_Ambient_Air_Temperature_Sensor::Connect_Ports( 
...
void DS18B20_Ambient_Air_Temperature_Sensor::Cyclic( void )
{
	if( this->One_Wire_Comm != 0 )
	{
		...
		else if( this->Last_Performed_Action == CONVERT_TEMPERATURE )
		{
			...
			this->Air_Temperature = read_bytes[0] | ( read_bytes[1] <<8 );
